...
public class AthCtx
{
	...
	/// <summary>
	///     How many levels in a row failed to load. A single broken level is ordinary and gets
	///     replaced; a streak means something is wrong with loading itself rather than with the
	///     levels, and every replacement is one more level burnt out of the pool for nothing.
	/// </summary>
