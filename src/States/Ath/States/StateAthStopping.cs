...
public class StateAthStopping(IStateMachine stateMachine) : AthState
{
    ...
    public override void Execute()
    {
        try
        {
            ...
            ChatMessageService.SendCustomMessage(AthStateMachine.Ctx.Messages.End());
    ...
    private void SavePlaylistIfConfigured()
    {
        ...
        string playlistName = $"ATH-RUN-{DateTime.Now.ToString($"yyyy-MM-dd_HH-mm-ss_{ctx.AuthorMedals}_{ctx.GoldMedals}_{ctx.Penalties}")}";
