...
logo. Put it here, then start `Thumbnail` from the Actions tab on GitHub to replace it - there is nothing to delete
first. Pushing alone changes nothing on the mod page.
